  ...
  return (
    <section className="w-full relative bg-white border-b border-slate-100 py-24 md:py-32">
      <div className="container mx-auto px-6 lg:px-12 max-w-[1400px]">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 mb-12 max-w-full overflow-hidden">
          <div className="flex flex-col gap-4 flex-1">
            <div className="relative w-full aspect-[4/3] lg:aspect-[16/10] rounded-[2rem] overflow-hidden group border border-slate-100 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-4 px-2">
              <div className="inline-flex items-center gap-2 bg-slate-100 px-3 py-1.5 md:px-4 md:py-2 rounded-full text-slate-900 font-medium text-[10px] md:text-sm w-fit">
                <span className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-red-500"></span> Initial State
              </div>
              <h5 className="text-slate-900 text-base md:text-2xl font-serif">Before Treatment</h5>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 md:gap-4 px-2">
              <div className="inline-flex items-center gap-2 bg-slate-100 px-3 py-1.5 md:px-4 md:py-2 rounded-full text-slate-900 font-medium text-[10px] md:text-sm w-fit">
                <span className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full bg-emerald-500"></span> Final Result
              </div>
              <h5 className="text-slate-900 text-base md:text-2xl font-serif">Post Treatment</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      {caseItem.progressImages && caseItem.progressImages.length > 0 && (
        <div className="w-full relative bg-[#0F0F0F] py-16 md:py-24 border-y border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.4)] mt-12 md:mt-24">
          ...
          <div className="embla overflow-hidden relative z-10 w-full pl-6 lg:pl-12" ref={emblaRef}>
            <div className="embla__container flex">
              {caseItem.progressImages.map((img: any, idx: number) => (
                <div key={idx} className="embla__slide flex-[0_0_90%] md:flex-[0_0_85%] lg:flex-[0_0_80%] xl:flex-[0_0_75%] min-w-0 mr-6 md:mr-10 relative flex flex-col gap-6">
                  <div className="w-full aspect-[4/3] lg:aspect-[16/9] rounded-[2rem] md:rounded-[3rem] overflow-hidden group shadow-2xl bg-slate-900 border border-white/5 relative">
                  ...
                  <div className="px-2 pb-8">
                    <p className="text-amber-400 font-bold text-[11px] md:text-sm mb-2 tracking-widest uppercase flex items-center gap-2">
                      <Activity className="w-4 h-4" /> Phase {idx + 1}: {img.timeframe}
                    </p>
                    <h5 className="text-white text-2xl lg:text-4xl font-serif leading-tight">{img.label}</h5>
                  </div>
                </div>
              ))}
            </div>
