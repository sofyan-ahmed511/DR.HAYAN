...
export const libraryVideos = [
  ...
  title: 'Clear Aligners vs. Metal Braces',
  description: 'Discover the key differences between clear aligners and traditional metal braces. Learn how they compare in appearance, comfort, effectiveness, treatment duration, cost, oral hygiene, and which option is best suited for different orthodontic cases.',
  thumbnail: 'https://i.postimg.cc/xC4Db5pj/Gemini-Generated-Image-9twln09twln09twl.jpg',
  duration: '01:26',
  url: 'https://youtu.be/tRYmrJy_4PQ?si=5dLZ46XkLQry8-od',
},
  {
    id: 'vid-4',
    category: 'brushing',
